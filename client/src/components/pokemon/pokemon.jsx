...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    const imageUrl = `https://assets.pokemon.com/assets/cms2/img/pokedex/detail/${lpad(pokemonIndex, 3)}.png`;
    ...
    await axios.get(pokemonSpeciesUrl).then(res => {
      ...
      const eggGroups = res.data['egg_groups'].map(group => {
        return group.name.toLowerCase().split(' ').map(s => s.charAt(0).toUpperCase() + s.substring(1))
          .join(' ')
      }).join(", ")
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-9">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                          <div className="progress">
                            <div className="progress-bar" role="progressBar" style={{ width: `${stats.hp}%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                          <div className="progress">
                            <div className="progress-bar" role="progressBar" style={{ width: `${stats.attack}%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                          <div className="progress">
                            <div className="progress-bar" role="progressBar" style={{ width: `${stats.defense}%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                          <div className="progress">
                            <div className="progress-bar" role="progressBar" style={{ width: `${stats.speed}%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                          <div className="progress">
                            <div className="progress-bar" role="progressBar" style={{ width: `${stats.specialAttack}%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                          <div className="progress">
                            <div className="progress-bar" role="progressBar" style={{ width: `${stats.specialDefense}%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="progress">
                            <div className="progress-bar" role="progressbar" style={{ width: `${genderRatioFemale}%`, backgroundColor: 'pink' }} aria-valuenow="15" aria-valuemin="0" aria-valuemax="0">
                              <small>{genderRatioFemale}</small>
                            </div>
                            <div className="progress-bar" role="progressbar" style={{ width: `${genderRatioMale}%`, backgroundColor: 'green' }} aria-valuenow="15" aria-valuemin="0" aria-valuemax="0">
                              <small>{genderRatioMale}</small></div>
                          </div>
                        </div>
                      </div>
                    </div>
